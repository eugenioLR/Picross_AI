...
#         for part in partitions(2):
#             self.assertTrue(sum(part) == 2)

#         for part in partitions(10):
#             self.assertTrue(sum(part) == 10)

#         for part in partitions(14):
#             self.assertTrue(sum(part) == 14)
